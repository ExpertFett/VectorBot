...
// Mounted at the App root so it shows on every screen (landing, server picker,
// dashboard). Fixed bottom-right, z-index 900 so a future modal can still cover it.
// Same invite + visual treatment as the DCS:OPT Planner so the family feels unified.
